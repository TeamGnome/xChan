...
namespace LibChan.FourChan
{
    ...
    {
        public override string DisplayName { get { return "4Chan";  } }
        public override string LogoUri { get { return "http://s.4cdn.org/image/fp/logo.png"; } }

        public override string JsonBoards { get { return "https://a.4cdn.org/boards.json"; } }
        public override string JsonCatalog { get { return "https://a.4cdn.org/{0}/catalog.json"; } }
        public override string JsonThread { get { return "https://a.4cdn.org/{0}/thread/{1}.json"; } }

        public override string WebThread { get { return "https://boards.4chan.org/{0}/thread/{1}"; } }
