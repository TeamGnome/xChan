...
namespace LibChan
{
    ...
    {
        public virtual string DisplayName { get { return "xChan"; } }
        public virtual string LogoUri { get { return ""; } }

        public virtual string JsonBoards { get { return "/boards.json"; } }
        public virtual string JsonCatalog { get { return "/{0}/catalog.json"; } }
        public virtual string JsonThread { get { return "/{0}/thread/{1}.json"; } }

        public virtual string WebThread { get { return "/{0}/thread/{1}"; } }
