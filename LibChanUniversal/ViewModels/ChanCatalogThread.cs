...
namespace LibChan.ViewModels
{
   public class ChanCatalogThread
   {
      ...
      public string SubjectSafe => WebUtility.HtmlDecode(Subject);

      public string CreatedString => TimeCreated.Humanize();

      public string PostedString => TimeLastPost.Humanize();
